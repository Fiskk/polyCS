...
$steps[] = array("image" => "vdi2-cobol.png", "text" => "Connect to cobol.cs.sunyit.edu:4000.  To access files on your home PC, click on Options.  Otherwise, click on Connect and skip to step 6");
...
$steps[] = array("image" => "vdi5.png", "text" => "The shared drive will be visible in My Computer");
...
$steps[] = array("image" => "vdi7-cobol.png", "text" => "The Cobol software can be found in the programs menu");
...
<h1>Help: Accessing the Cobol Software</h1>

<div id='content'>

<BR>
<P>Follow the steps below to connect to the cobol desktops.  Click on an image for a larger view.</p>
