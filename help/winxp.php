...
$steps[] = array("image" => "vdi2.png", "text" => "Connect to winxp.cs.sunyit.edu.  To access files on your home PC, click on Options.  Otherwise, click on Connect and skip to step 6");
...
<h1>Help: Accessing the CS Virtual Windows Lab</h1>

<div id='content'>

<BR>
<P>Follow the steps below to connect to the Windows remote desktops.  Click on an image for a larger view.</p>
