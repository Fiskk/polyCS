...
<BR>
<P><?= $step++ ?>. Be sure you are running Acrobat Reader X.  If not, <a TARGET="_BLANK" href="http://get.adobe.com/reader/">download it</a>.</p>
<BR>
...
<BR>
<? create_image_link("cert1-X.jpg"); ?>
<P><?= $step++ ?>. Open Acrobat and click Edit / Protection / Security Settings.</p>
<BR>
...
<P><?= $step++ ?>. If you see this warning, you must follow the steps to <a href="acrobat_trust.php">establish trust</a>.</P>
<BR>

<BR>
<? create_image_link("cert12.jpg"); ?>
<P><?= $step++ ?>. If you see this notification, all is well and you are done.</p>
<BR>
