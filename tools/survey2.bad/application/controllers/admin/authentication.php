...
class Authentication extends Survey_Common_Action
{
    ...
    */
	...
	// redirect to survey homepage after logout as webauth is still active
	echo "<meta http-equiv='Refresh' content='0;url=https://www.cs.sunyit.edu/tools/survey2/'>";
	//echo "<meta http-equiv='Refresh' content='0;url=" .$_SERVER['web_root']. "'>";
	//echo " <script> alert('" .$_SERVER['web_root']. "'); </script>";
    }
